...
export function StorefrontFooter({ store, locale }: StorefrontFooterProps) {
    ...
    <footer className="border-t border-[var(--border)] bg-[var(--muted)]/30">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a
                href="#"
                className="size-10 flex items-center justify-center rounded-full bg-[var(--background)] border border-[var(--border)] text-[var(--muted-foreground)] hover:text-[var(--primary)] hover:border-[var(--primary)] transition-colors"
              >
          ...
          {/* Account Links */}
          <div>
            <h4 className="font-semibold text-[var(--foreground)] mb-4">Account</h4>
            <ul className="space-y-2">
      ...
      <div className="border-t border-[var(--border)]">
        <div className="container mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-[var(--muted-foreground)]">
            Powered by <strong className="text-[var(--foreground)]">Matgary</strong>
          </p>
        </div>
      </div>
